...
namespace Pattons_Best
{
   ...
   public enum GameAction
   {
      ...
      MovementBattlePhaseStartCounterattack,
      ...
      MovementBattlePhaseStartDueToAdvance,
      MovementRainRoll,
      MovementRainRollEnd,
      MovementSnowRoll,
      MovementSnowRollEnd,
      ...
      BattleRoundSequenceMgPlaceAdvanceFire,
      BattleRoundSequenceMgAdvanceFireRoll,
      BattleRoundSequenceMgAdvanceFireRollEnd,
