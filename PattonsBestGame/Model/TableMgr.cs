...
namespace PattonsBest
{
   public class TableMgr
   {
      ...
      public static string SetEnemyUnit(EnumScenario situation, int day, int dieRoll)
      {
         ...
         Logger.Log(LogEnum.LE_ERROR, "Set_EnemyUnit(): Reached Default with dr=" + dieRoll.ToString() + " situation=" + situation.ToString() + " on day=" + day.ToString());
         return "ERROR";
      }
      ...
      public static int GetEnemyActionModifier(IGameInstance gi, IMapItem mi)
      {
         ...
         if ("ERROR" == enemyUnit)
         {
            Logger.Log(LogEnum.LE_ERROR, "Get_EnemyActionModifier(): unknown enemyUnit=" + mi.Name);
            return FN_ERROR;
         }
         //----------------------------------------------------
         IAfterActionReport? lastReport = gi.Reports.GetLast();
         if (null == lastReport)
         {
            Logger.Log(LogEnum.LE_ERROR, "Get_EnemyActionModifier(): lastReport=null");
            return FN_ERROR;
         }
         //----------------------------------------------------
         int modifier = 0;
         switch (enemyUnit)
         {
            ...
            case "JdgPz38t":
               ...
               break;
            default:
               Logger.Log(LogEnum.LE_ERROR, "Get_EnemyActionModifier(): reached default with enemyUnit=" + enemyUnit);
               return FN_ERROR;
         }
         return modifier;
      }
      public static string SetEnemyActionResult(IGameInstance gi, IMapItem mi, int dieRoll)
      {
         ...
         bool isDoNothingDueToWeather = false;  // If fog or falling snow, do not fire if not at close range
         ...
         if ('C' != name[name.Length - 1])
         {
            if (true == lastReport.Weather.Contains("Fog") || true == lastReport.Weather.Contains("Falling"))
               isDoNothingDueToWeather = true;
         }
         //----------------------------------------------------
         bool isDoNothingInsteadDueToHidden = false;
         if (EnumSpottingResult.HIDDEN == mi.Spotting)
            isDoNothingInsteadDueToHidden = true;
         //----------------------------------------------------
         ...
         {
            Logger.Log(LogEnum.LE_ERROR, "Set_EnemyActionResult(): Get_EnemyActionModifier() returned error");
            return "ERROR";
         }
         dieRoll += modifier;
         //----------------------------------------------------
               ...
               case "MG":
                  ...
                  else if (dieRoll < 21)
                  {
                     if( true == isDoNothingDueToInterdicted )
                        currentAction = "Do Nothing (i)";
                     else
                        currentAction = "Move-F";
                  }
                  else if (dieRoll < 31)
                  {
                     if (true == isDoNothingDueToInterdicted)
                  ...
                  else if (dieRoll < 61)
                  {
                     if (true == isDoNothingDueToInterdicted)
                        ...
                        currentAction = "Move-B";
                  }
                  else if (dieRoll < 96)
                  {
                     if (true == isDoNothingDueToWeather)
                        currentAction = "Do Nothing (w)";
                     else
                        currentAction = "Fire-Infantry";
                  }
                  ...
                  else if (dieRoll < 66)
                  {
                     ...
                     else if ((null != gi.TargetMainGun) && (mi.Name == gi.TargetMainGun.Name))
                     {
                        if (true == isDoNothingInsteadDueToHidden)
                           currentAction = "Do Nothing (h)";
                        else
                           currentAction = "Fire-Your Tank (4)";
                     }
                     else
                     {
                        currentAction = "Fire-Any Tank";
                     }
                  }
                  else if (dieRoll < 71)
                  {
                  ...
                  else if (dieRoll < 81)
                  {
                     if (mi.Name == targetNameIfFiringAtFront)
                     {
                        if (true == isDoNothingDueToWeather)
                           ...
                           currentAction = "Fire-Your Tank (5)";
                     }
                     else if ((null != gi.TargetMainGun) && (mi.Name == gi.TargetMainGun.Name))
                     {
                        if (true == isThrownTrack)
         ...
         if (true == optionEnemyContinueMove.IsEnabled)
         {
            ...
            if ((true == currentAction.Contains("Move")) && (true == mi.LastMoveAction.Contains("Move")) && (randomNum < 2) && (false == isDoNothingDueToInterdicted) ) // 66% chance continue on same path
            {
               ...
               if( true == currentAction.Contains("-F")) // if in zones 1,2,3, and get a Move-F results, assume this is advancing troops overrunning and penetrating further in US zones, i.e. toward offboard
               {
                  if (('1' == sector) || ('2' == sector) || ('3' == sector))
                     currentAction = "Move-B (c)";
               }
            }
         }
         if (true == currentAction.Contains("Move"))
            mi.LastMoveAction = currentAction;
         if (true == currentAction.Contains("(i)"))
         {
      ...
      public static string GetCollateralDamage(IGameInstance gi, int dieRoll)
      {
         ...
         if (dieRoll < 81)
         {
            ...
            foreach (IMapItem mi in gi.Hatches)
            {
               if (true == mi.Name.Contains("Asssistant"))
               {
                  hatch = mi;
                  break;
               }
      ...
      public static int GetWoundsModifier(IGameInstance gi, ICrewMember cm, bool isGunFire, bool isBailout, bool isCollateralDamage)
      {
            ...
            if (null != death)
            {
               switch (death.myEnemyFireDirection)
               {
                  ...
                  case "H BR":
                     ...
                     {
                        modifier -= 30;
                        Logger.Log(LogEnum.LE_SHOW_WOUND_MOD, "Get_ExplosioGetWoundsModifiernModifier(): mod-30 direction=" + death.myEnemyFireDirection + " mod=" + modifier.ToString() + " for cm=" + cm.Role);
                     }
                     break;
                  case "H FL":
                     if (("Driver" == cm.Role) || ("Loader" == cm.Role))
         ...
         if (true == isCollateralDamage)
         {
            foreach (IMapItem crewAction in gi.CrewActions)
            {
               if ("Commander" == cm.Role)
               {
                  if (("Commander_FireAaMg" == crewAction.Name) || ("Commander_FireSubMg" == crewAction.Name))
                  {
                     modifier += 5;
               ...
               else if ("Loader" == cm.Role)
               {
                  if (("Loader_FireAaMg" == crewAction.Name) || ("Loader_FireSubMg" == crewAction.Name))
                  {
                     modifier += 5;
                     Logger.Log(LogEnum.LE_SHOW_WOUND_MOD, "GetWoundsModifier(): mod+5 MG and isCollateralDamage=true mod=" + modifier.ToString() + " for cm=" + cm.Role);
                     break;
      ...
      public static string SetWounds(IGameInstance gi, ICrewMember cm, int dieRoll, int modifier)
      {
         if (100 == dieRoll) // unmodified die roll 100 is always a kill
         {
            if( false == gi.SetIncapacitated(cm)) // Set_Wounds() - rolled 100
         ...
         else if (dieRoll < 48)
         {
            ...
            if ((true == gi.IsMinefieldAttack) || (null == gi.Death))
            {
               if( false == gi.SetIncapacitated(cm)) // Set_Wounds() - minefield attack
                  Logger.Log(LogEnum.LE_ERROR, "Set_Wounds(): Set_Incapacitated() returned null for cm=" + cm.Role);
         ...
         else
         {
            ...
            if ("Commander" == cm.Role)
            {
               ...
               if (true == option.IsEnabled) // End game when commander is kill if this option is enabled
               {
                  ...
                  if (null == commander)
                  {
                     Logger.Log(LogEnum.LE_ERROR, "Set_Wounds(): GetCrewMemberByRole() returned nullfor cm=" + cm.Role);
                  }
                  else
                  {
      ...
      public static IMapItem? GetAppearingUnit(IGameInstance gi, IMapItem mi)
      {
         ...
         if (true == mi.Name.Contains("ATG"))
         {
            ...
            {
               Logger.Log(LogEnum.LE_SHOW_APPEARING_UNITS, "Get_AppearingUnit(): gi.IdentifiedAtg=null");
               return null;
            }
         ...
         else if (true == mi.Name.Contains("TANK"))
         {
            ...
            {
               Logger.Log(LogEnum.LE_SHOW_APPEARING_UNITS, "Get_AppearingUnit(): gi.IdentifiedTank=null");
               return null;
            }
         ...
         else if (true == mi.Name.Contains("SPG"))
         {
            ...
            {
               Logger.Log(LogEnum.LE_SHOW_APPEARING_UNITS, "Get_AppearingUnit(): gi.IdentifiedSpg=null");
               return null;
            }
         ...
         {
            gi.Sherman.EnemyAcquiredShots[appearingMapItem.Name] = gi.Sherman.EnemyAcquiredShots[mi.Name];  // Get_AppearingUnit()
      ...
      public static IMapItem? GetAppearingUnitNew(IGameInstance gi, IMapItem mi, int dieRoll)
      {
         ...
         if (true == mi.Name.Contains("ATG"))
         {
            if (dieRoll < 4)
            {
               ...
               Utilities.MapItemNum++;
               appearingMapItem = new MapItem(name, mi.Zoom, "c93Pak38", mi.TerritoryCurrent);
               Logger.Log(LogEnum.LE_SHOW_APPEARING_UNITS, "Get_AppearingUnitNew(): eu=" + name + " dr=" + dieRoll.ToString());
         ...
         if (null == appearingMapItem)
         {
            Logger.Log(LogEnum.LE_ERROR, "Get_AppearingUnitNew(): reached default mi=" + mi.Name);
            return null;
         }
         if (true == gi.Sherman.EnemyAcquiredShots.ContainsKey(mi.Name)) // transfer over the acquisition counter
         {
            gi.Sherman.EnemyAcquiredShots[appearingMapItem.Name] = gi.Sherman.EnemyAcquiredShots[mi.Name]; // Get_AppearingUnitNew()
            gi.Sherman.EnemyAcquiredShots.Remove(mi.Name);
         }
         return appearingMapItem;
      }
      ...
      public static int GetFriendlyActionModifier(IGameInstance gi, IMapItem mi, int numUsControlledSector, bool isAirStrike, bool isAdvancingFire, bool isOnBoardArtilleryFire, bool isOffBoardArillery )
      {
         ...
         //----------------------------------------------------
         else if (true == isInfantryTargetInWoods)  // isOffBoardArillery=true
         {
      ...
      {
         theCombatCalendarEntries.Add(new CombatCalendarEntry("07/27/44", EnumScenario.Advance, 3, EnumResistance.Light, "Cobra Breakout")); // Day=0
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("07/31/44", EnumScenario.Advance, 2, EnumResistance.Light)); // Day=4
         //---------------------------------------------------------------------------------------------------------------
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("09/02-09/10 1943", EnumScenario.Retrofit, 10, EnumResistance.None));               // +++++++++++++++++++++++++++++++++Day=37 -> 8 days
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("09/15/44", EnumScenario.Battle, 9, EnumResistance.Medium, "Crevic and Maixe"));
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("09/23-09/24 1943", EnumScenario.Retrofit, 10, EnumResistance.None));                // +++++++++++++++++++++++++++++++++Day=50 -- 1 days
         //---------------------------------------------------------------------------------------------------------------------
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("09/30/44", EnumScenario.Counterattack, 2, EnumResistance.Light));                   // Day=56
         //---------------------------------------------------------------------------------------------------------------
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/01/44", EnumScenario.Counterattack, 2, EnumResistance.Light));     //************Oct 1st
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/02/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/03/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/04/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/05/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/06/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/07/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/08/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/09/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/10/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/11/44", EnumScenario.Counterattack, 2, EnumResistance.Light));
         theCombatCalendarEntries.Add(new CombatCalendarEntry("10/12-11/08 1943", EnumScenario.Retrofit, 10, EnumResistance.None));                // +++++++++++++++++++++++++++++++++Day=68 --> 27 days
         //---------------------------------------------------------------------------------------------------------------
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("12/07-12/20 1943", EnumScenario.Retrofit, 10, EnumResistance.None));                         //  +++++++++++++++++++++++++++++++++Day=97 -> 13 dyas
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("01/03-01/08 1944", EnumScenario.Retrofit, 10, EnumResistance.None)); //  +++++++++++++++++++++++++++++++++Day=111 -> 5 days
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("02/03-02/21 1944", EnumScenario.Retrofit, 10, EnumResistance.None));                   //  +++++++++++++++++++++++++++++++++Day=137 -> 18 days
         ...
         theCombatCalendarEntries.Add(new CombatCalendarEntry("03/03-03/04 1944", EnumScenario.Retrofit, 10, EnumResistance.None)); //  +++++++++++++++++++++++++++++++++ Day=147 -> 1 day
         //---------------------------------------------------------------------------------------------------------------------
